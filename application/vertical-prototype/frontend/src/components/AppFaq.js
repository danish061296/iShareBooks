    ...
    <div className="faq__container" id="faq" data-aos="fade-right">
      <div className="faq">
        ...
        <Accordion className="faq__accor">
          ...
          <AccordionDetails>
            <Typography className="faq__answers">
              We'll need to send you order confirmations, shipping information,
              buyback reminders, and communications like that about your order.
              It's really easy to create one - you just need an email and
              password - and once you have an account with us you'll be able to:
              place orders quickly and easily, track your orders online, access
              your order history, and buyback information, and other reminders.
            </Typography>
          </AccordionDetails>
        </Accordion>
        <Accordion className="faq__accor">
        ...
        <Accordion className="faq__accor">
          ...
          <AccordionDetails>
            <Typography className="faq__answers">
              You can cancel your order or make a change to it by contacting us
              at +1 415-123-4567 or at help@isharebook.com as soon as possible
              after your order is placed with your name, order number, and a
              request for cancellation or a description of the requested change.
              We will do our best to cancel or modify your order, but we will
              not be able to complete the cancellation if your order has been
        ...
        <Accordion className="faq__accor">
          ...
          <AccordionDetails className="faq_details">
            <Typography className="faq__answers">
              Actually, it was the Library of Congress, not the American Library
              Association, that created the Books That Shaped America List,
              which is actually the 88 titles selected to be part of their
